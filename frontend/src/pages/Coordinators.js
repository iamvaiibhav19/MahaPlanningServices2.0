...
export default function Coordinators() {
  ...
  const getCoordinators = async () => {
    ...
    axios.get(`${process.env.REACT_APP_BASE_URL}/api/v1/getCoordinators`, config).then((res) => {
      console.log(res, 'res');
  ...
  const handleAddCoordinator = () => {
    ...
    axios
      .post(`${process.env.REACT_APP_BASE_URL}/api/v1/assignRole`, newCoordinator, config)
      .then((res) => {
        console.log(res, 'res');
        setOpenModal(false);
        getCoordinators();
  ...
  const handleOpenEditModal = () => {
    ...
    axios.get(`${process.env.REACT_APP_BASE_URL}/api/v1/coordinator/${coordinatorId}`, config).then((res) => {
      console.log(res, 'res');
  ...
  const handleDeleteCoordinator = () => {
    ...
    axios.delete(`${process.env.REACT_APP_BASE_URL}/api/v1/coordinator/${coordinatorId}`, config).then((res) => {
      console.log(res, 'res');
      setOpenModal(false);
      handleCloseMenu();
      setCoordinatorId('');
  ...
  const handleEditCoordinator = () => {
    ...
    axios
      .put(`${process.env.REACT_APP_BASE_URL}/api/v1/coordinator/${coordinatorId}`, editData, config)
      .then((res) => {
        console.log(res, 'res');
        setOpenModal(false);
